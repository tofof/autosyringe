...
void loop() {
  ...
  // tft.print("GLCD:Sphinx of black quartz, judge my vow.");    
  // tft.println();
  // tft.setTextFont(FONT2);    
  // tft.print("2:Sphinx of black quartz, judge my vow.");    
  // tft.println();
  // tft.setTextFont(FONT4);    
  // tft.print("4:Sphinx of black quartz, judge my vow.");    
  // tft.println();
  // tft.setTextFont(FONT6);    
  // tft.print("6:0123456789:-.a m|p");    
  // tft.println();
  // tft.setTextFont(FONT7);    
  // tft.print("7:0123456789:.-");    
  // tft.println();
  // tft.setTextFont(FONT8);    
  // tft.print("8:01234567890:-.");    
  // tft.println();
  ...
  // Free font tests
  tft.fillScreen(TFT_NAVY); // Clear screen to navy background
  tft.setTextColor(TFT_WHITE, TFT_BLACK); //the black won't render if I do print
  tft.setCursor(xpos, ypos);

  //Sans
  tft.setFreeFont(FF17);
  tft.println();          // Free fonts plot with baseline datum, so we must move the cursor down a line from the 0,0 position
  tft.print(sFF17);
  ...
  tft.println();          // Bonus line to separate the two styles
  tft.println();          // Free fonts plot with baseline datum, so we must move the cursor down a line from the 0,0 position
  tft.print(sFF21);
